...
const ProgressBar: React.FC<UploadProgressProps> = ({
  ...
  return (
    <div className="fixed z-50 bottom-4 right-4 space-y-2 mr-5 w-auto p-4 bg-card text-card-foreground rounded shadow-lg">
        ...
        <div key={upload.fileName} className="p-3 bg-background rounded-lg shadow-md">
          <div className="flex justify-between items-center">
            <div>
              ...
              <Progress value={upload.progress} className="w-56 h-2 mt-1 bg-secondary" />
